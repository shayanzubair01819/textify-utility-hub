...
export const UnderlineTextEditor = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-2 sm:p-4 md:p-6 space-y-4 sm:space-y-6 animate-fadeIn">
      <div className="text-center mb-4 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-2">Underline Text Generator – Convert & Copy Underlined Text Online</h1>
        <p className="text-sm sm:text-base text-slate-600">
          Looking for a quick way to underline text online? Our Underline Text Generator makes it easy!
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-3 sm:p-4 md:p-6 space-y-3 sm:space-y-4">
        ...
        {isMarkdownPreview ? (
          ...
          <textarea 
            ...
            placeholder="Enter or paste your text here to underline it... (Ctrl+B for bold, Ctrl+I for italic, Ctrl+S to save)"
            style={{
              fontFamily,
              fontSize,
              lineHeight,
...
export default UnderlineTextEditor;
